...
class CreateConveniosDetallesSegregablesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('convenios_detalles_segregables', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('convenios_detalles_segregables');
    }
}
