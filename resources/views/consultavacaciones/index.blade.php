        ...
        <div class="card">
            ...
            <table id="exportOptionsDatatables" class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table"
                ...
                <tr>
                    ...
                    @if ($vacacion->status=='CANCELADO')
                    <td>{{$vacacion->updated_at}}</td>
                    @else
                    ...
                    @foreach($jefe as $autoriza)
                        @if($autoriza->id_puesto == $vacacion->jefe_directo)
