    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('importarmasivas') }}" id="form1" method="POST" enctype="multipart/form-data">
                    @csrf
...
<script>
    ...
    $( "#actualizar" ).click(function() {
        ...
        Swal.fire('Las vacaciones masivas han sido guardadas')
    });
