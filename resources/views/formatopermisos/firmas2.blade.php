...
@section('content')
 <!--<script type="text/javascript" src="SigWebTablet.js"></script>-->
  ...
  function onDone()
  {
    ...
    {
      alert("Ingrese una firma para continuar");
    }
    else
    {
...
<body onload="onSign();">
  ...
  <table border="1" cellpadding="2"  width="500"  style="margin: 100 auto;">
    <tr  >
      <td height="100" width="500"  >
        <!--<canvas id="cnv" name="cnv" width="500" height="100"></canvas>-->
        <canvas id="cnv" name="cnv"  width="700px" height="400px" style="border:1px solid #000000;"  ></canvas>
		{!! BootForm::text('folio', $folio); !!}
      </td>
    </tr>
  </table>
 ...
 <!--  <canvas name="SigImg" id="SigImg" width="500" height="100"></canvas>
	...
	<form action="#" method="GET" name=FORM1 style="margin: auto; width: 220px;" enctype="multipart/form-data">
   <!-- <form action="#" name=FORM1 style="margin: auto; width: 220px;" ENCTYPE='multipart/form-data'>-->
      <p>
       <!-- <input id="SignBtn" name="SignBtn" type="button" value="Sign"  onclick="javascript:onSign()"/>&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<td><button type="button" name="ClearBtn" id='button1' value="Limpiar" class="btn btn-primary" onclick="javascript:onClear()">Limpiar</button></td>

    <!--    <input id="button2" name="DoneBtn" type="button" value="Aceptar" onclick="javascript:onDone()"/>&nbsp;&nbsp;&nbsp;&nbsp; href="{!! route('estatuspermisos.index')!!} -->
        <td><a class="btn btn-info"  name="DoneBtn" id='button2'  onclick="javascript:onDone()" href="{!! route('estatuspermisos.index',$folio)!!} " >Aceptar</a></td>
