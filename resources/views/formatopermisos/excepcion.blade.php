...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3>Solicitud de Permisos (Excepcion)</h3>
        </div>
        <div class="card-body">
            ...
            @forelse($datosEmpleado as $permiso)
                ...
                {!! BootForm::hidden('excepcion', $excepcion); !!}
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3"  style="display: none" id='id_inicio_per'>
                        {!! BootForm::date('inicio_per', 'INICIO DE PERMISO','',['width'=>'col-md-3', 'min'=>$ayer]) !!}
                    </div>
                    <div class="col-lg-3 col-md-3"  style="display: none" id='id_fin_per'>
                        {!! BootForm::date('fin_per', 'FIN DE PERMISO','',['width'=>'col-md-3', 'min'=> $ayer]) !!}
                    </div>
                  ...
                  <!--  <div class="col-lg-3 col-md-3">
                       ...
                       {!! BootForm::text('no_permisos', 'NO. DE PERMISOS EN EL MES ',$no_permiso, ['width'=>'col-md-3','readonly']); !!}
                   </div>-->
                ...
                <div class="col-lg-6 col-md-6"  style="display: none" id='id_modo_permiso'>
                        ...
                        <select class='form-control' aria-label="Default select example" name="modo_permiso" id="modo_permiso">
                            <option value= 0 >{{'--SELECCIONE--'}}</option>
                     ...
                     <div class="col-lg-6 col-md-6"  style="display: none" id='id_hora_comida'>
                        ...
                        <select class='form-control' aria-label="Default select example" name="hora_comida" id="hora_comida">
                            <option value= 0 >{{'--SELECCIONE--'}}</option>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3"  style="display: none" id='id_inicio_diahor'>
                        {!! BootForm::date('inicio_diahor', 'DIA DE PERMISO','',['width'=>'col-md-3', 'min'=>$ayer]) !!}
                    </div>
                    <div class="col-lg-3 col-md-3"  style="display: none" id='id_fin_hor'>
                        {!! BootForm::time('inicio_hor', 'HORA INICIAL','',['width'=>'col-md-3' ] ) !!}
                    </div>
                    <div class="col-lg-3 col-md-3"  style="display: none" id='id_inicio_hor'>
                        {!! BootForm::time('fin_hor', 'HORA FINAL','',['width'=>'col-md-3']) !!}
                    </div>
                ...
                <div class="row" style="display: none" id ='id_enviar'>
                    <div class="col center">
                        <button type="submit" name="solicitar" id='solicitar' value="Solicitar permisos" class="btn btn-primary">Enviar</button>
...
<script>
    $(document).ready(function() {
        ...
        if($('input[name=excepcion]').val() != 1  ){

                 Swal.fire({
                     title: '',
                     text: "Estimado colaborador, tu no tienes los privilegios para ingresar una excepción, acude con el Gerente de Area o VP correspondiente",
     ...
     /*   if($('#no_permisos').val() >= 1 ){

                 Swal.fire({
                     title: '',
                     text: "Estimado colaborador, has cubierto el número de permisos permitidos en el mes",
                     imageUrl: 'img/logo.png',
                     imageWidth: 300,
                     imageHeight: 150,
                     imageAlt: 'Custom image',
    ...
    $('#id_motivo').show();
        ...
        $.get('{{ url("/")}}/consultasajax/getmotivopermisos/' + tipo,function(data) {
            ...
            $.each(data, function(fetch, regenciesObj){
                $('#motivo').append('<option value="'+ regenciesObj.id_permiso +'">'+ regenciesObj.permiso +'</option>');
            })
                });
                $('#id_inicio_per').hide();
                $('#id_fin_per').hide();
...
$('#motivo').change(function () {
    ...
    $.get('{{ url("/")}}/consultasajax/getautorizar/' + tipo ,function(data) {
     ...
     //   $('#autorizar').append('<option value="0">'+'--SELECCIONE--'+'</option>');
        $.each(data, function(fetch, regenciesObj){
            $('#autorizar').append('<option value="'+ regenciesObj.No_Empleado +'">'+ regenciesObj.Nom_Emp + ' ' + regenciesObj.Ap_Pat + ' ' + regenciesObj.Ap_Mat +'</option>');
        })
     });
...
$('#fin_per').change(function () {
    ...
    $('#inicio_hor').change(function () {
        ...
        if (minutos_final < minutos_inicio){
            Swal.fire({
                     title: '',
                     text: "Estimado colaborador, la hora de entrada no puede ser menor a la hora de salida de la empresa",
                     imageUrl: 'img/logo.png',
                     imageWidth: 300,
                     imageHeight: 150,
                     imageAlt: 'Custom image',
