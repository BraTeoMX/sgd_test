...
<div>
       @component('mail::button', ['url' =>  url('https://padbee.cloudjinx.com/hooks/1/timeoff?id='.$vac->folio_vac.'&action=APLICADO'),'color' => 'primary',])
                Aceptar
            @endcomponent
...
<br>
<div>
        @component('mail::button', ['url' =>  url('https://padbee.cloudjinx.com/hooks/1/timeoff?id='.$vac->folio_vac.'&action=DENEGADO'),'color' => 'error',])
                Denegar
            @endcomponent
