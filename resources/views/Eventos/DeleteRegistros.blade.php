...
@section('content')
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ route('eventos.PreRegistro') }}" class="btn btn-primary deleteReg">Regresar</a>
        </div>
        <div class="card-body">
            <h2>Selecciona una opción</h2>
            <form action="{{ route('eventos.DeleteRegistros') }}" method="post">
                    ...
                    <tbody>
                        @foreach($registros as $registro)
                            <tr>
                                ...
                                <td>
                                    {!! Form::model($registro, ['method' => 'delete', 'route' => ['eventos.BorrarRegistro', $registro->id], 'id' => 'eventoEliminarForm']) !!}
